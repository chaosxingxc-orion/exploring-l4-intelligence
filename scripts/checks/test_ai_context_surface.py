...
class AiContextRepositoryPolicyTests(unittest.TestCase):
    ...
    def test_research_objective_is_bounded_current_truth(self) -> None:
        ...
        required_truth = (
            ...
            "Owner GO was",
            "signed 2026-08-03",
            "speech-only boundary",
            "candidate method are Stage‑2 outputs",
            "final validation is Stage‑3",
            "fail-closed behind E0 D1–D4",
            "D0 is closed",
            "SLUE-SQA-5, ContextASR-Bench and AMI",
            "FSD50K, AudioSet and ESC-50",
            "H5 remains",
