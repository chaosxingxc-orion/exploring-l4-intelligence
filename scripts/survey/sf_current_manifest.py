...
BASE_FILE_SPECS = (
    ...
    *tuple(
    ...
    FileSpec(
        "proposal_source_manifest_v1",
        "wiki/survey/current/data/proposal-source-manifest-v1.json",
        "frozen",
        "targeted",
    ),
)
