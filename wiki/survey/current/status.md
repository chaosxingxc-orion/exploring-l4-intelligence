...
- Audio2Tool: the revision manifest contains 71,441 files / 10,410,773,494 bytes with zero missing;
  11 auxiliary files and 610 retained extraneous files are accounted separately. Stage-2 must use the
  revision-bound allowlist; no user files were deleted.
- Gate assets: UniSRM-Bench is local at revision
  `b96b356e2aa2db1fb3b14883c90acafb653958ca` with 1,463/1,463 files and zero missing. SpeakerSleuth,
