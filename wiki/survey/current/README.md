...
- Gate: **Stage-1C v2 Agentic calibration R1 owner consolidation decision**; endpoint `AGENTIC_CALIBRATION_R1_AGREEMENT_FAILED_OWNER_DECISION_REQUIRED`.
...
- Recommended next token:
  `AUTHORIZE_STAGE1C_V2_AGENTIC_CALIBRATION_R1_CODEBOOK_CONSOLIDATION`. It permits one bounded
  consolidation and a full same-N=56 recode by two new isolated contexts, not score rewriting.
