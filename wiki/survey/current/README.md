...
- Independent review verified 30/30 RC2R2 and 26/26 predecessor artifacts but returned
  `WITHHOLD_WITH_BOUNDED_DEFECTS`: threshold override, expected-value receipt self-attestation and
  structural path aliases remain.
...
- RC2R3 freezes the 0.85 threshold, receiver-side actual-byte receipts and typed structural paths.
  ...
  branch-aware coverage pass. It is independently accepted but not yet distributed.
