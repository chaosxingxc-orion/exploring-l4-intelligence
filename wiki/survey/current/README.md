...
- Owner direction-viability criterion (2026-07-29, Decision-Log 续76): sufficient survey plus in-domain
  prior work as a methodological comparison baseline, or cross-domain-informed design where the field is
  empty; both must compare against the incumbent SOTA baseline on a concrete task.
- Effective contract: [`research-directions.md`](research-directions.md) — the capability-first candidate
  portfolio across knowledge, memory, skills, agentic system and evolution, with API-only, reliable capability lift,
  context-mediated control and Lean/empirical-boundary rules. Candidate IDs do not imply Stage-2 entry.
- Read [`status.md`](status.md) → [`research-directions.md`](research-directions.md) → immutable
...
- Prior C1/C2/C3 evidence remains targeted at
  [`stage1c-common-rubric-comparison.md`](tables/stage1c-common-rubric-comparison.md); its ranking and
  C1-primary disposition are superseded.
