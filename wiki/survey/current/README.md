...
- Speech/omni evidence: the
  [81-work coverage ledger](data/stage1b-speech-omni-prior-coverage-v1.json) provides unique routing;
  the [nine-work known-prior reconciliation](data/stage1b-known-prior-reconciliation-v1.json) and
  [closed 18-work promotion reconciliation](data/stage1b-eligible-bundle-reconciliation-v1.json) reuse
  canonical IDs; the [46-row supplement](data/stage1b-speech-direct-prior-supplement-v3.json) supplies
  comparable evidence; and the [control-basis table](data/stage1b-direct-control-basis-v2.json)
  prevents orchestration, judges and reward-guided selection from being conflated.
- Release proof: `docs/checks/stage1b-closeout/2026-07-23-v5/release-manifest.json` binds 64 Git and 44
  external artifacts. `release-replay.json` verifies all 108 against commit
  `38fb9435d0c35e226ad62b16015a6dbee054e6c2`.
- Asset proof: the v5 check directory contains semantically equal Python/PowerShell layered inventories,
  Audio2Tool content accounting and the executable evidence-contract receipt. Public dataset bytes stay
