...
- **Current state:** Stage-1A only. Schema-v3 evidence remediation and protocol-v2 consolidation are
  technically implemented; the canonical v6 report is
  `docs/checks/system-first-stage1a/evidence-v6/identity-taxonomy-v6-test.json`. This does not establish
  reviewer sign-off, readiness, or owner Stage-1B approval.
- **Next authorized work:** finish the compact context/audit package and request independent re-review.
  No discovery query, research-model smoke, mapping execution, or prototype before explicit approval.
