...
| `release-signature` | owner release signature | `wiki/audit/system-first-stage1b-capability-delta/release-signature/2026-07-24-stage1b-capability-delta-release-signature.md` @ `a5af670aacbb5194f42947150440cd022b16c652` | `SIGN_STAGE1B_CAPABILITY_DELTA_RELEASE` |

The 14-work capability overlay is released against the exact reviewed RC1 bytes. Its signature permits
the overlay to enter the deterministic Stage-1C calibration input; it does not authorize 320-paper
full mapping, research execution, ranking, selection or a novelty verdict.
