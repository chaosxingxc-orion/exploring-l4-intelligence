...
> **📌 引用新鲜度合规注记（2026-07-12 追加，本调研文本不改、作有日期记录保留）**：依 Decision-Log 续17（方向影响型主张须 ≥1 篇 ≥2025-01 一手锚定；较早著作须带 [谱系]/[标准]/[已弃用] 角色标签），本调研的 direction-claims 已在 **FULL 提案**（`2026-07-12-research-proposal-omni-agentic-frontend-FULL.md` §1.2/§2.2/§2.4/§7/§2.6）完成合规再锚，本survey**不重复改写**。已在 FULL 内落实者：
> - **自由改写 GER 在强低-WER 核心上净有害**（原锚 Apple 2405.15216，C5）→ 2025 一手再锚 **LIR-ASR arXiv:2509.15095（2025-09，去约束令 CER/WER ~2.3× 劣化）** + **arXiv:2501.15310（2025-01，强核心纠错后 WER 反升）**；旧源标 **[已弃用]**。
> - **受约束 N-best 选择 = 安全 training-free 原语**（原锚剑桥 2307.04172/C7、Amazon TAP 2309.15649/C8）→ 2025 一手再锚 **SEAL arXiv:2501.08421（2025-01）** + LIR-ASR；旧源标 **[谱系]**。**⚠ 修正**：无 2025 一手跑正面 head-to-head，且剑桥 2409.09554（2024）示强 LLM 无约束可超 oracle → 适用性为 **regime/能力条件性**（详 FULL §2.2 ⚠ 注）。
> - **外部-LM 重排序天花板低（~9–16% 相对）**（谱系 Salazar 1910.14659/C2、Conformer 2005.08100/C1、AED 2104.05544）→ 2025+ 一手再锚 **arXiv:2606.23306（2026-06）** + **CHSER arXiv:2505.18463（2025-05，零样本→微调后增益从 28.5%→13.3% 坍缩，即弱基线伪影机制）**；pre-2025 谱系行标 **[标准]/[谱系]**（该论点主要承载于本 survey §2，未改 FULL 正文）。
> - **GER 大数皆 fine-tuned**（HyPoradise 2309.15701→[已弃用]、RobustGER 2401.10446→[已弃用]、ClozeGER 2405.10025→[谱系]、GenSEC 2409.09785→[已弃用]）；**ROVER/Fiscus 1997→[谱系]**（借用基础设施，非理论贡献）。
> - **再听（re-listening）前沿**：**AVGER 已补一手 ID arXiv:2501.04038（2025-01，视听 GER，LRS3 相对 WER −24%）**；**⚠** 纯音频-for-WER 切片仍主要靠 2024 ClozeGER，证据偏薄（详 FULL §2.4 ⚠ 注）。
>
