# Decision Log — 2026 volume

> Append-only, lightweight ADRs — the team's durable **memory**. This is the **2026 volume**; the
> stable entry point and volume index is [[Decision-Log]]. One entry per decision: date · what we
> decided · why · consequences. Humans and AIs append 2026 decisions here (see
