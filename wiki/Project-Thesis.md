...
**Program statement (owner rulings 2026-07-14/15, Decision-Log continuation entries 45/46; Gate S0 SIGNED 2026-07-15,
...
- **External control plane** — the agent scaffold around the frozen core (supply, memory, tools,
  evaluation, selection, budget, stopping); the registered plain name for what was colloquially
  called "peripheral optimization".
...
(Decision-Log continuation entry 91). The umbrella Wiki manages study state, experiment protocols, asset links and
...
continuation entries 45/46; canonical force is formalized by the Gate S0 signature. Prior full text:
git history (`git show e482465:wiki/Project-Thesis.md`); dead terms & incident history:
