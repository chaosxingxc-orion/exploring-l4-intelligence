> **⛔ SUPERSEDED (2026-07-11)** — 本文 headline 事实已过时；现行真源：[[2026-07-09-stage1-three-step-experiment-design]] 与 Decision-Log 续11 G0 裁定（07-04 计划线归档）。按 append-only 保留原文，未改写。归档于 [[2026-07-11-stage1-audit-response-and-rulings]] 裁定的 wiki 治理动作。
