> **⛔ SUPERSEDED (2026-07-11)** — 本文 headline 事实已过时；现行真源：[[Per-Work-Status]]（本表中 emotion pooling Δ+0.097 ✅ 已改判 NULL，95% t-CI [−0.043,+0.116] 跨 0）。按 append-only 保留原文，未改写。归档于 [[2026-07-11-stage1-audit-response-and-rulings]] 裁定的 wiki 治理动作。
