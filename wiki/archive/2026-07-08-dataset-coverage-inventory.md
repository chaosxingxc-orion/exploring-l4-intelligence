> **⛔ SUPERSEDED (2026-07-11)** — 本文 headline 事实已过时；现行真源：[[2026-07-09-coverage-dataset-taxonomy]]（39 在盘/29 纳入取代 28/17 口径）。按 append-only 保留原文，未改写。归档于 [[2026-07-11-stage1-audit-response-and-rulings]] 裁定的 wiki 治理动作。
